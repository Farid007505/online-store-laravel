                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input value="{{ !empty($address) ? $address->email : '' }}" type="text"
                                            name="email" id="email" placeholder="Enter Your last name"
                                            class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <textarea value="" name="address" id="address" class="form-control" cols="30" rows="5"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input value="{{ !empty($address) ? $address->state : '' }}" type="text"
                                            name="state" id="state" placeholder="Enter Your appartment"
                                            class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input value="{{ !empty($address) ? $address->zip : '' }}" type="text"
                                            name="zip" id="zip" placeholder="Enter Your appartment"
                                            class="form-control">
                                        <p></p>
                                    </div>
