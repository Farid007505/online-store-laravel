            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card">
                        ...
                        <form action="" name="changePasswordForm" id="changePasswordForm" method="POST">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == true) {
                        ...
                        $("#old_password").removeClass('invalid-feedback').siblings('p')
                            .removeClass(
                                'is-invalid').html('');
                        $("#new_password").removeClass('invalid-feedback').siblings('p')
                            .removeClass(
                                'is-invalid').html('');
                        $("#confirm_password").removeClass('invalid-feedback').siblings('p')
                            .removeClass(
                                'is-invalid').html('');
                        ...
                        if (errors.new_password) {
                            ...
                            $("#new_password").removeClass('iis-invalid').siblings('p')
                                .removeClass(
                                    'invalid-feedback').html('');
                        }
