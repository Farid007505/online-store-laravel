                ...
                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <textarea name="order_notes" id="order_notes" cols="30" rows="2" placeholder="Order Notes (optional)"
                                                class="form-control" value="{{ !empty($customerAddress) ? $customerAddress->notes : '' }}"></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between summery-end">
                                    ...
                                    <div class="h6"><strong>${{ Cart::subtotal() }}</strong>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between summery-end">
                        ...
                        <div class="card payment-form ">
                            ...
                            <div class="">
                                <input type="radio" name="payment_method" value="code" id="payment_method_two">
