                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $page->slug }}" type="text" name="slug" id="slug"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" id="content" cols="30" rows="10" placeholder="content" class="summernote">{{ $page->content }}</textarea>
                                    <p></p>
                                </div>
                            </div>
                        </div>
