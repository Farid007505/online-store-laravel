            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    @can('subcategories create')
                        <a href="{{ route('sub-categories.create') }}" class="btn btn-primary">Create SubCategory</a>
                    @endcan
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('sub-categories.index') }}'"
                                class=" btn
                            btn-default btn-sm">Reset</button>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        @can('subcategories edit')
                                            ...
                                            @can('subcategories delete')
                                                <a href="#" onclick="deletesubcategory({{ $subcat->id }})"
