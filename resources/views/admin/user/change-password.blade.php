...
<script>
    $("#changePassword").submit(function(event) {
        ...
        $.ajax({
            url: '{{ route('admin.processShowChangePassword') }}',
            type: 'post',
            ...
            success: function(response) {
                ...
                if (response['status'] == true) {
                    ...
                    if (errors['old_password']) {
                        ...
                        $("#old_password").removeClass('is-invalid').siblings('p').
                        removeClass('invalid-feedback').html(errors['old_password']);
                    }
                    ...
                    if (errors['new_password']) {
                        ...
                        $("#new_password").removeClass('is-invalid').siblings('p').
                        removeClass('invalid-feedback').html(errors['new_password']);
                    }
                    ...
                    if (errors['confirm_password']) {
                        ...
                        $("#confirm_password").removeClass('is-invalid').siblings('p').
                        removeClass('invalid-feedback').html(errors['confirm_password']);
                    }
                }
